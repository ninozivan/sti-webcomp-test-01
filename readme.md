...
### Add new SVG icons
1. Copy new SVG files into the `src/svg` folder.
2. Run `svgo -f ./src/svg -o ./src/svg-optimized`
3. Run `npm run-script svg-shapes-to-json`
4. Run `npm run-script generate-index-page`
5. Run `npm start`
